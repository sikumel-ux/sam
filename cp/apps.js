...
async function simpanKas() {
  ...
  if(!amt || !ket) return Swal.fire('Eits!', 'Lengkapi data!', 'warning');
...
async function muatLaporan() {
  ...
  log.innerHTML = "<center><i class='fas fa-sync fa-spin'></i> Menarik data...</center>";
  try {
    ...
    log.innerHTML = html || "<center>Belum ada data.</center>";
  } catch (e) { log.innerHTML = "Gagal load data."; }
}
